...
public interface Browser {
	 ...
	 * @param locator_name  - The locator by which the element to be found
	...
	public org.openqa.selenium.WebElement inspectElement(String locator_name , String Locator_Value);
